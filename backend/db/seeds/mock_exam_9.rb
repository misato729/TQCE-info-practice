...
河合塾学園ドルトンスクール『学校紹介』 | https://www.dalton-school.ed.jp/about/",
  ...
  },
  {
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "生徒の{{①}}などを積極的に評価し，学習したことの{{②}}を実感できるようにすること。また，各教科・科目等の目標の実現に向けた学習状況を把握する観点から，単元や題材など内容や時間のまとまりを見通しながら{{③}}を工夫して，{{④}}を評価し，指導の改善や学習意欲の向上を図り，資質・能力の育成に生かすようにすること。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["到達度や成績", "役割や成果", "学習計画や内容", "知識及び技能"]),
      fill_in_choice.call("イ", ["学習態度や意欲", "必要性や有用性", "評価規準や評価方法", "学習状況や課題"]),
      fill_in_choice.call("ウ", ["よい点や進歩の状況", "意義や価値", "評価の場面や方法", "学習の過程や成果"], true),
      fill_in_choice.call("エ", ["長所や課題", "成果や達成感", "指導の場面や方法", "学習の結果や到達度"]),
    ],
    explanation_blocks: [
      text_block.call("ウが原文と一致します。学習評価では、生徒のよい点や進歩の状況を積極的に評価して学習の意義や価値を実感できるようにし、評価の場面や方法を工夫して学習の過程や成果を評価します。アは成績や知識・技能だけを対象とする表現、イは評価規準ではなく評価の場面や方法を工夫する点、エは「長所や課題」「成果や達成感」等が原文と異なります。"),
    ],
  ...
  },
  {
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "海外から帰国した生徒などについては，{{①}}を図るとともに，{{②}}を生かすなどの適切な指導を行うものとする。\n日本語の習得に困難のある生徒については，個々の生徒の実態に応じた{{③}}の工夫を{{④}}に行うものとする。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["日本の学校文化への理解", "母語や文化", "学習内容や教材", "個別的かつ継続的"]),
      fill_in_choice.call("イ", ["高等学校教育への移行", "海外で身に付けた知識及び技能", "教育課程や指導計画", "段階的かつ継続的"]),
      fill_in_choice.call("ウ", ["日本語指導への参加", "国際的視野", "学習形態や指導体制", "計画的かつ個別的"]),
      fill_in_choice.call("エ", ["学校生活への適応", "外国における生活経験", "指導内容や指導方法", "組織的かつ計画的"], true),
    ],
    explanation_blocks: [
      text_block.call("エが原文と一致します。海外から帰国した生徒等には、学校生活への適応を図り、外国における生活経験を生かす指導を行います。日本語の習得に困難のある生徒には、実態に応じた指導内容や指導方法の工夫を組織的かつ計画的に行います。アは四語とも、イは教育課程の移行に関する規定ではない点、ウは「日本語指導への参加」「国際的視野」等が原文と異なります。"),
    ],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第1章第5款2（2）ア・イ | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 8,
    major_category_code: "teacher_education",
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "探究の過程においては，{{①}}学習活動や，{{②}}などの学習活動が行われるようにすること。その際，例えば，{{③}}などの{{④}}が自在に活用されるようにすること。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["個別に課題を設定して解決する", "資料を比較し評価する", "観察・実験・調査", "問題解決の手順"]),
      fill_in_choice.call("イ", ["他者と協働して課題を解決しようとする", "言語により分析し，まとめたり表現したりする", "比較する，分類する，関連付ける", "考えるための技法"], true),
      fill_in_choice.call("ウ", ["集団で役割を分担して実践する", "情報機器を用いて収集・発信する", "課題の設定，情報の収集，整理・分析", "探究の過程"]),
      fill_in_choice.call("エ", ["地域と連携して社会課題に取り組む", "発表や討論を行う", "記録する，要約する，発表する", "言語活動"]),
    ],
    explanation_blocks: [
      text_block.call("イが原文と一致します。探究の過程では、他者と協働して課題を解決しようとする学習、言語により分析し、まとめたり表現したりする学習を行い、「比較する、分類する、関連付ける」などの考えるための技法を自在に活用します。アは協働と言語活動を別の活動へ置き換えています。ウは探究過程の段階名を「考えるための技法」としている点、エは具体的な技法と上位概念の対応が異なります。"),
    ],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第4章第3の2（4） | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 9,
    major_category_code: "teacher_education",
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "その際，{{①}}の「{{②}}」及び「{{③}}」並びに{{④}}が，人間としての在り方生き方に関する中核的な指導の場面であることに配慮すること。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["公民科", "公共", "倫理", "特別活動"], true),
      fill_in_choice.call("イ", ["公民科", "公共", "政治・経済", "総合的な探究の時間"]),
      fill_in_choice.call("ウ", ["地理歴史科", "地理総合", "歴史総合", "特別活動"]),
      fill_in_choice.call("エ", ["公民科", "倫理", "政治・経済", "生徒会活動"]),
    ],
    explanation_blocks: [
      text_block.call("アが原文と一致します。人間としての在り方生き方に関する中核的な指導の場面として、公民科の「公共」「倫理」と特別活動が示されています。イは「政治・経済」と総合的な探究の時間、ウは教科及び科目が異なり、エは「公共」がなく特別活動を生徒会活動に限定しています。"),
    ],
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は，「高等学校学習指導要領」（平成30年3月文部科学省告示第68号）の「第5章 特別活動 第2 各活動・学校行事の目標及び内容〔学校行事〕」からの抜粋である。文章中の空欄 {{①}} ～ {{④}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。",
      },
      {
        type: "fill_in_quote",
        text: "全校若しくは学年又はそれらに準ずる集団を単位として，次の各行事において，学校生活に{{①}}を与え，学校生活の{{②}}に資する{{③}}を行うことを通して，それぞれの学校行事の意義及び活動を行う上で必要となることについて理解し，{{④}}できるよう指導する。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["秩序と統一", "向上と発展", "協働的な活動", "計画的に参加して活動"]),
      fill_in_choice.call("イ", ["節目と変化", "充実と向上", "自治的な活動", "自発的に考えて運営"]),
      fill_in_choice.call("ウ", ["秩序と変化", "充実と発展", "体験的な活動", "主体的に考えて実践"], true),
      fill_in_choice.call("エ", ["規律と活気", "改善と発展", "集団的な活動", "協働的に判断して参加"]),
    ],
    explanation_blocks: [
      text_block.call("ウが原文と一致します。学校行事は学校生活に秩序と変化を与え、学校生活の充実と発展に資する体験的な活動を通して、行事の意義等を理解し、主体的に考えて実践できるようにします。アは「秩序と統一」「協働的な活動」、イは「節目」「自治的な活動」、エは四語全てが原文の表現と異なります。"),
    ],
  ...
  },
  {
    ...
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領」（平成30年3月文部科学省告示第68号）の「第3章 主として専門学科において開設される各教科 第7節 情報 第2款 各科目 第8 データベース 3 内容の取扱い」からの抜粋である。文章中の空欄 {{①}} ～ {{③}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "（1）内容を取り扱う際には，次の事項に配慮するものとする。\nア　社会で利用されている具体的なデータベースを取り上げ，{{①}}を通して，データベースの{{②}}などの視点から社会の中でデータベースが果たす役割を理解できるよう留意して指導すること。\nイ　生徒や地域の実態，学科の特色等に応じて，適切な{{③}}を選択すること。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["調査", "構築や利用，評価と改善", "データ形式やデータモデル"]),
      fill_in_choice.call("イ", ["実習", "定義や検索，分析と可視化", "データ定義言語や統計ソフトウェア"]),
      fill_in_choice.call("ウ", ["演習", "設計や操作，運用と保守", "プログラミング言語や開発環境"]),
      fill_in_choice.call("エ", ["実習", "設計や操作，運用と保守", "データベース操作言語やデータベース管理システム"], true),
    ],
    explanation_blocks: [text_block.call("エが原文と一致します。社会で利用される具体的なデータベースの実習を通し，設計や操作，運用と保守の視点から役割を理解します。また，実態等に応じてデータベース操作言語やデータベース管理システムを選びます。アは①～③の全て，イは②・③，ウは①・③が原文と異なります。")],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第3章第7節第2款第8「データベース」3（1） | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 17,
    major_category_code: "information",
    ...
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領（平成30年告示）解説 情報編」（平成30年7月文部科学省）の「第1部 各学科に共通する教科『情報』 第2章 共通教科情報科の各科目 第2節 情報Ⅱ」からの抜粋である。文章中の空欄 {{①}} ～ {{③}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "ここでは，情報の科学的な見方・考え方を働かせて，問題を明確にし，分析方針を立て，社会の様々なデータ，情報システムや情報通信ネットワークに接続された情報機器により生成されているデータについて，{{①}}などを行う。また，その結果を考察する学習活動を通して，社会や身近な生活の中でデータサイエンスに関する多様な知識や技術を用いて，{{②}}など，機械学習を活用した様々な製品やサービスが開発されたり，新たな知見が生み出されたりしていることを理解するようにする。\n更に，不確実な事象を予測するなどの問題発見・解決行うために，データの収集，整理，整形，モデル化，可視化，分析，評価，実行，効果検証などの各過程における方法を理解し，必要な技能を身に付け，データに基づいて{{③}}ことにより問題解決に取り組む力を養うことをねらいとしている。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["収集，分類，予測", "自動運転，音声合成", "統計的に推測する"]),
      fill_in_choice.call("イ", ["整理，整形，分析", "人工知能による画像認識，翻訳", "科学的に考える"], true),
      fill_in_choice.call("ウ", ["整理，統合，可視化", "人工知能による検索，推薦", "客観的に判断する"]),
      fill_in_choice.call("エ", ["加工，抽出，評価", "ロボットによる制御，翻訳", "数理的にモデル化する"]),
    ],
    explanation_blocks: [text_block.call("イが原文と一致します。データについて整理，整形，分析を行い，人工知能による画像認識や翻訳などの機械学習の活用を理解します。さらに，データに基づいて科学的に考える力を養います。アは，①を収集，分類，予測，②を自動運転，音声合成，③を統計的に推測するとする点が原文と異なります。ウは，整形を統合とし，画像認識・翻訳を検索・推薦とし，科学的に考えるを客観的に判断するとしています。エは，加工，抽出，評価／ロボットによる制御，翻訳／数理的にモデル化するのいずれも原文の語句ではありません。")],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）解説 情報編』第1部第2章第2節2（3） | https://www.mext.go.jp/content/1407073_11_1_2.pdf",
  },
  {
    question_number: 18,
    major_category_code: "information",
    category_code: "information_specialized",
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領（平成30年告示）解説 情報編」（平成30年7月文部科学省）の「第2部 主として専門学科において開設される教科『情報』 第2章 専門教科情報科の各科目 第11節 メディアとサービス」からの抜粋である。文章中の空欄 {{①}} ～ {{④}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "ここでは，科目の目標を踏まえ，情報通信ネットワークやメディアを統合したコンテンツの扱いに関する知識と技術を基盤として，メディアを利用したサービスの{{①}}を捉え，利用者の目的や状況に合わせてメディアを利用したサービスの{{②}}などをする力，{{③}}などの技術的安全性及び{{④}}などの社会的安全性を意識して，メディアを利用したサービスを適切に扱う態度を養うことをねらいとしている。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["経済的価値", "設計，制作，発信", "可用性や保守性", "著作権や法令遵守"]),
      fill_in_choice.call("イ", ["公共的役割", "分析，評価，改善", "情報の信頼性", "個人情報の保護"]),
      fill_in_choice.call("ウ", ["社会的価値", "企画，選択，活用", "情報セキュリティ", "プライバシーや情報倫理"], true),
      fill_in_choice.call("エ", ["社会的影響", "企画，運用，管理", "システムの安全性", "情報モラルや職業倫理"]),
    ],
  ...
  },
  {
    ...
    category_code: "information_specialized",
    content_blocks: [
      text_block.call("ある地域で，日平均気温x（℃）と飲料販売数y（本）の関係を調べたところ，観測された気温の範囲は10℃以上30℃以下で，相関係数は0.78，最小二乗法による回帰直線は ŷ = 120 + 8.5x となった。この結果の解釈として最も適切なものを，下のア～エの中から一つ選んで記号で答えなさい。"),
    ],
    choices: [
      text_choice.call("ア", "切片が120であることから，この地域では気温が0℃の日に飲料が実際に必ず120本売れ，この値は観測範囲外でも同じ精度で保証される。"),
      text_choice.call("イ", "観測された気温の範囲内では，気温が1℃高いときに予測される販売数は平均して8.5本多いと解釈できるが，この分析だけから気温上昇が販売数増加の原因だとは断定できない。", true),
      text_choice.call("ウ", "相関係数が0.78であるため，販売数の変動の78%が気温によって説明される。説明される割合は相関係数をそのまま百分率にすればよい。"),
      text_choice.call("エ", "気温と販売数の役割を入れ替えて気温を販売数から予測する場合，回帰直線の傾きは必ず1÷8.5となり，元の回帰直線と同じ予測結果を与える。"),
    ],
    explanation_blocks: [
      text_block.call("イが適切です。傾き8.5は，観測範囲内で気温が1℃高いとき，回帰直線による販売数の予測値が平均して8.5本多くなることを表します。ただし，相関や回帰だけでは因果関係を断定できません。アは，0℃が観測範囲外であるにもかかわらず切片を実測値として保証し，外挿の不確かさを無視しています。ウは，相関係数rと決定係数r²を混同しています。単回帰で説明される変動の割合に対応する値は0.78²=0.6084，すなわち約60.8%です。エは，yをxから予測する回帰とxをyから予測する回帰とを混同しています。目的変数と説明変数を入れ替えた回帰の傾きは，一般に元の傾きの逆数にはなりません。"),
      {
        type: "code",
        title: "決定係数の計算",
        code: "r² = 0.78² = 0.6084 ≈ 60.8%",
      },
    ],
    source_text: "文部科学省『高等学校情報科「情報Ⅰ」教員研修用教材（本編）』第4章 データの活用 | https://www.mext.go.jp/content/20200722-mxt_jogai02-100013300_006.pdf\n総務省統計局 Data StaRt『相関と回帰』 | https://www.stat.go.jp/dstart/point/seminar/02/3-3-2.html",
  },
]

unless questions.map { |question| question.fetch(:question_number) } == (1..20).to_a
  raise "模擬試験9には問1から問20を順番に登録してください"
end
