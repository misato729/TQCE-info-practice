...
questions = [
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『教育基本法』第10条第1項の条文である。空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『学校教育法』第72条の一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『教育公務員特例法』第22条第2項の条文である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領第1章総則に示された、育成を目指す資質・能力に関する記述である。空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領のカリキュラム・マネジメントに関する規定の一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校の『総合的な探究の時間』の目標の一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領の道徳教育に関する配慮事項の一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領における情報科の各科目の履修に関する規定である。空欄 {{①}}・{{②}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領『情報Ⅱ』の『情報システムとプログラミング』の一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、高等学校学習指導要領における情報科の内容の取扱いの一部である。空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを選びなさい。",
      },
      {
        type: "fill_in_quote",
