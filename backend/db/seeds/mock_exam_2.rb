...
questions = [
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『教育基本法』（平成18年法律第120号）第13条の条文である。文章中の空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『学校教育法』（昭和22年法律第26号）第51条第3号の条文である。文章中の空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『地方公務員法』（昭和25年法律第261号）第35条の条文である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』第1章総則第2款3(5)の一部である。文章中の空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』第1章第5款1(3)の一部である。文章中の空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』第4章第1(3)の一部である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』第1章第7款3の一部である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』第5章「特別活動」におけるホームルーム活動の目標の一部である。文章中の空欄 {{①}} 〜 {{③}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、文部科学省『生徒指導提要』（令和4年12月）が示す、生徒指導を実践する上で留意する四つの視点である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
        text: "(1) {{①}}の感受\n(2) {{②}}な人間関係の育成\n(3) {{③}}の場の提供\n(4) {{④}}な風土の醸成",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、中央教育審議会答申『「令和の日本型学校教育」の構築を目指して』（令和3年1月26日）の一部である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』の「情報Ⅰ」2(4)ア(イ)に示された知識及び技能である。文章中の空欄 {{①}} 〜 {{④}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
  ...
  },
  {
    ...
    content_blocks: [
      {
        type: "fill_in_text",
        text: "次の文章は、『高等学校学習指導要領（平成30年告示）』に示された「情報Ⅱ」の内容構成である。文章中の空欄 {{①}} 〜 {{⑤}} に当てはまる語句の組合せとして正しいものを、下のア〜エの中から一つ選びなさい。",
      },
      {
        type: "fill_in_quote",
        text: "(1) {{①}}\n(2) {{②}}\n(3) {{③}}\n(4) {{④}}\n(5) {{⑤}}",
