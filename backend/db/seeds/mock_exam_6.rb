...
questions = [
  ...
  },
  {
    ...
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領」（平成30年3月文部科学省告示第68号）の「第2章 各学科に共通する各教科 第10節 情報 第2款 各科目 第1 情報Ⅰ 2 内容（1）情報社会の問題解決」からの抜粋である。文章中の空欄 {{①}} ～ {{③}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "情報と情報技術を活用した問題の発見・解決の方法に着目し，情報社会の問題を発見・解決する活動を通して，次の事項を身に付けることができるよう指導する。\nア　次のような知識及び技能を身に付けること。\n（ア）情報や{{①}}の特性を踏まえ，情報と情報技術を活用して問題を発見・解決する方法を身に付けること。\n（イ）情報に関する法規や制度，{{②}}の重要性，情報社会における個人の責任及び{{③}}について理解すること。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["メディア", "情報セキュリティ", "情報モラル"], true),
      fill_in_choice.call("イ", ["メディア", "個人情報の保護", "情報倫理"]),
      fill_in_choice.call("ウ", ["コミュニケーション", "情報セキュリティ", "情報倫理"]),
      fill_in_choice.call("エ", ["データ", "情報の信頼性", "情報モラル"]),
    ],
    explanation_blocks: [text_block.call("アが原文と一致します。イは①のみ一致し，②は「情報セキュリティ」，③は「情報モラル」です。ウは②のみ一致し，①をコミュニケーション，③を情報倫理としています。エは③のみ一致し，①をデータ，②を情報の信頼性としています。")],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第2章第10節第2款第1「情報Ⅰ」2（1） | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 17,
    major_category_code: "information",
    category_code: "information_education",
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領」（平成30年3月文部科学省告示第68号）の「第3章 主として専門学科において開設される各教科 第7節 情報 第2款 各科目 第1 情報産業と社会 3 内容の取扱い」からの抜粋である。文章中の空欄 {{①}} ～ {{④}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "（1）内容を取り扱う際には，次の事項に配慮するものとする。\nア　情報産業が社会で果たしている役割を扱うとともに，社会の情報化について，{{①}}と関連付けて考察するよう留意して指導すること。\nイ　社会の情報化が人々の生活に与えている影響について，{{②}}を課題として取り上げ，情報社会の将来について{{③}}に考察させ，情報産業に携わる者に求められる{{④}}を踏まえ合理的かつ創造的に課題を解決できるよう留意して指導すること。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["情報産業の構造", "地域産業の事例", "主体的", "責任感"]),
      fill_in_choice.call("イ", ["情報技術者の職業倫理", "最新技術の事例", "協働的", "情報モラル"]),
      fill_in_choice.call("ウ", ["情報技術者の業務内容", "身近にある具体的な事例", "主体的かつ協働的", "倫理観"], true),
      fill_in_choice.call("エ", ["情報システムの運用", "社会課題の統計資料", "科学的かつ客観的", "使命感"]),
    ],
    explanation_blocks: [text_block.call("ウが原文と一致します。アは①～④のいずれも原文の語句と異なります。イは関連する概念を組み合わせていますが，社会の情報化は情報技術者の「業務内容」と関連付け，「身近にある具体的な事例」を扱います。エの情報システムの運用，統計資料，科学的かつ客観的，使命感も，この規定の語句ではありません。")],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第3章第7節第2款第1「情報産業と社会」3（1） | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 18,
    major_category_code: "information",
    category_code: "information_education",
    content_blocks: [
      { type: "fill_in_text", text: "次の文章は，「高等学校学習指導要領（平成30年告示）解説 情報編」（平成30年7月文部科学省）の「第1部 各学科に共通する教科『情報』 第1章 総説 第2節 共通教科情報科改訂の趣旨及び要点」からの抜粋である。文章中の空欄 {{①}} ～ {{③}} に当てはまる語句の組合せとして正しいものを，下のア～エの中から一つ選んで記号で答えなさい。" },
      { type: "fill_in_quote", text: "共通教科情報科の科目構成については，平成21年改訂の高等学校学習指導要領の「社会と情報」及び「情報の科学」の2科目からの{{①}}を改め，問題の発見・解決に向けて，事象を情報とその結び付きの視点から捉え，情報技術を適切かつ効果的に活用する力を全ての生徒に育む共通必履修科目としての「情報Ⅰ」を設けるとともに，「情報Ⅰ」において培った基礎の上に，問題の発見・解決に向けて，情報システムや多様なデータを適切かつ効果的に活用する力やコンテンツを創造する力を育む「情報Ⅰ」の{{②}}としての「情報Ⅱ」を設けた。なお，標準単位数はいずれも{{③}}である。" },
    ],
    choices: [
      fill_in_choice.call("ア", ["自由選択", "発展的な必履修科目", "2単位"]),
      fill_in_choice.call("イ", ["選択必履修", "応用的な選択科目", "4単位"]),
      fill_in_choice.call("ウ", ["共通必履修", "発展的な選択科目", "4単位"]),
      fill_in_choice.call("エ", ["選択必履修", "発展的な選択科目", "2単位"], true),
    ],
