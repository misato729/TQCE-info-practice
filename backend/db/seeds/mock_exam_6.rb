...
questions = [
  ...
  },
  {
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "第1款の3の（1）から（3）までに示すことが{{①}}よう，{{②}}など{{③}}を見通しながら，生徒の{{④}}の実現に向けた授業改善を行うこと。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["相互に関連付けられる", "単元や題材", "学習内容の系統", "個別最適な学び"]),
      fill_in_choice.call("イ", ["段階的に実現される", "年間指導計画", "教育課程全体", "探究的な学び"]),
      fill_in_choice.call("ウ", ["偏りなく実現される", "単元や題材", "内容や時間のまとまり", "主体的・対話的で深い学び"], true),
      fill_in_choice.call("エ", ["偏りなく育成される", "単元や領域", "指導と評価の一体化", "主体的・協働的な学び"]),
    ],
    explanation_blocks: [
      text_block.call("ウが原文と一致します。第1款に示す資質・能力の三つの柱が偏りなく実現されるよう、単元や題材など内容や時間のまとまりを見通し、主体的・対話的で深い学びの実現に向けた授業改善を行うことが求められます。アは①・③・④、イは四語全て、エは「実現」「題材」「内容や時間のまとまり」「対話的」の各語が原文と異なります。"),
    ],
  ...
  },
  {
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "学校の教育活動全体を通じて，個々の生徒の{{①}}に努め，その{{②}}こと。また，生徒が適切な{{③}}を選択し学校やホームルームでの生活によりよく適応するとともに，現在及び将来の生き方を考え行動する{{④}}を育成することができるようにすること。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["特性等の的確な把握", "伸長を図る", "各教科・科目や類型", "態度や能力"], true),
      fill_in_choice.call("イ", ["学習状況の継続的な評価", "改善を図る", "学校設定科目や系列", "資質・能力"]),
      fill_in_choice.call("ウ", ["興味・関心等の把握", "活用を図る", "必履修教科・科目", "自主性や社会性"]),
      fill_in_choice.call("エ", ["進路希望の組織的な把握", "実現を支援する", "各教科・科目やコース", "判断力や実践力"]),
    ],
    explanation_blocks: [
      text_block.call("アが原文と一致します。ガイダンスの機能の充実に関する規定では、個々の生徒の特性等を的確に把握してその伸長を図り、各教科・科目や類型の選択、学校生活への適応、現在及び将来の生き方を考えて行動する態度や能力の育成を支援します。イ・ウ・エはいずれも、把握の対象、支援の方向、選択対象又は育成対象を原文とは異なる語句へ置き換えています。"),
    ],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）』第1章第5款1（4） | https://www.mext.go.jp/content/20230120-mxt_kyoiku02-100002604_03.pdf",
  },
  {
    question_number: 8,
    major_category_code: "teacher_education",
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "高等学校においてこのような生徒の姿を実現していくに当たっては，生徒が取り組む探究がより洗練された質の高いものであることが求められる。質の高い探究とは，次の二つで考えることができる。\n\n一つは，探究の過程が高度化するということである。高度化とは，①探究において目的と解決の方法に矛盾がない（{{①}}），②探究において適切に資質・能力を活用している（効果性），③焦点化し深く掘り下げて探究している（{{②}}），④幅広い可能性を視野に入れながら探究している（広角性）などの姿で捉えることができる。\n\nもう一つは，探究が自律的に行われるということである。具体的には，①自分にとって関わりが深い課題になる（{{③}}），②探究の過程を見通しつつ，自分の力で進められる（運用），③得られた知見を生かして社会に参画しようとする（{{④}}）などの姿で捉えることができる。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["効果性", "広角性", "自己課題", "社会参画"]),
      fill_in_choice.call("イ", ["整合性", "広角性", "運用", "社会参画"]),
      fill_in_choice.call("ウ", ["効果性", "鋭角性", "自己課題", "運用"]),
      fill_in_choice.call("エ", ["整合性", "鋭角性", "自己課題", "社会参画"], true),
    ],
    explanation_blocks: [
      text_block.call("エが原文と一致します。目的と解決方法に矛盾がないことは「整合性」、焦点化して深く掘り下げることは「鋭角性」です。また、自分との関わりが深い課題となる姿は「自己課題」、得た知見を社会に生かそうとする姿は「社会参画」とされます。アは①を「効果性」、②を「広角性」としており、それぞれ別の説明に対応します。イは②が「鋭角性」、③が「自己課題」でなければなりません。ウは①が「整合性」、④が「社会参画」でなければなりません。"),
    ],
    source_text: "文部科学省『高等学校学習指導要領（平成30年告示）解説 総合的な探究の時間編』第2章1『探究が高度化し，自律的に行われること』 | https://www.mext.go.jp/content/20260115-mxt__kyoiku01_2_9.pdf",
  },
  {
    question_number: 9,
    major_category_code: "teacher_education",
    ...
    content_blocks: [
      ...
      {
        type: "fill_in_quote",
        text: "道徳教育は，教育基本法及び学校教育法に定められた{{①}}に基づき，生徒が自己探求と自己実現に努め国家・社会の一員としての自覚に基づき行為しうる{{②}}にあることを考慮し，{{③}}を考え，主体的な判断の下に行動し，自立した人間として他者と共によりよく生きるための基盤となる{{④}}を養うことを目標とすること。",
      },
    ],
    choices: [
      fill_in_choice.call("ア", ["法令に示された教育目標", "心身の発達段階", "自己の将来", "人格"]),
      fill_in_choice.call("イ", ["教育基本法の理念", "青年期", "社会の形成者としての生き方", "公共性"]),
      fill_in_choice.call("ウ", ["教育の根本精神", "発達の段階", "人間としての在り方生き方", "道徳性"], true),
      fill_in_choice.call("エ", ["学校教育の目的", "成熟の段階", "自己の在り方", "規範意識"]),
    ],
    explanation_blocks: [
      text_block.call("ウが原文と一致します。高等学校の道徳教育は、教育の根本精神に基づき、生徒の発達の段階を考慮し、人間としての在り方生き方を考えて主体的に判断・行動する基盤となる道徳性を養うことを目標とします。ア・イ・エは、法的根拠、発達上の捉え方、考察対象又は育成対象を原文とは異なる概念へ置き換えています。"),
    ],
  ...
  },
  {
    ...
    category_code: "information_specialized",
    content_blocks: [
      text_block.call("次の①～⑤のデータについて，尺度水準を名義尺度，順序尺度，間隔尺度，比例尺度に分類した組合せとして最も適切なものを，下のア～エの中から一つ選んで記号で答えなさい。"),
      {
        type: "table",
        headers: ["データ", "内容"],
        rows: [
          ["①", "主な通学手段（徒歩，自転車，バス，鉄道など）"],
          ["②", "学校生活への満足度（1：不満～5：満足）"],
          ["③", "教室の気温（摂氏）"],
          ["④", "通学時間（分）"],
          ["⑤", "西暦で表した入学年"],
    ...
    choices: [
      text_choice.call("ア", "① 名義尺度 ／ ② 順序尺度 ／ ③ 比例尺度 ／ ④ 比例尺度 ／ ⑤ 間隔尺度"),
      text_choice.call("イ", "① 名義尺度 ／ ② 名義尺度 ／ ③ 間隔尺度 ／ ④ 比例尺度 ／ ⑤ 順序尺度"),
      text_choice.call("ウ", "① 順序尺度 ／ ② 順序尺度 ／ ③ 間隔尺度 ／ ④ 間隔尺度 ／ ⑤ 間隔尺度"),
      text_choice.call("エ", "① 名義尺度 ／ ② 順序尺度 ／ ③ 間隔尺度 ／ ④ 比例尺度 ／ ⑤ 間隔尺度", true),
    ],
    explanation_blocks: [
      text_block.call("エが適切です。①は種類を区別するだけで大小関係がないため名義尺度，②は満足度の順序に意味がある一方，隣り合う値の差が等しいとは限らないため順序尺度です。③の摂氏温度は値の差に意味がありますが，0℃が温度の不在を示さず，20℃が10℃の2倍の温かさとはいえないため間隔尺度です。④の通学時間は0分が時間の不在を表し，比にも意味があるため比例尺度です。⑤の西暦年は年の差に意味がありますが，西暦0年を絶対的な原点として経過時間の比を表すものではないため間隔尺度です。アは③を比例尺度としている点，イは②を名義尺度，⑤を順序尺度としている点，ウは①を順序尺度，④を間隔尺度としている点がそれぞれ誤りです。"),
    ],
...
unless questions.map { |question| question.fetch(:question_number) } == (1..20).to_a
  raise "模擬試験6には問1から問20を順番に登録してください"
end
